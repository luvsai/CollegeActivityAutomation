...
class publications(models.Model):
    ...
    P_IF_State = models.CharField(default="", verbose_name="Impact Factor State", max_length=100)
    P_IF_Value  = models.CharField(default="", verbose_name="Impact Factor Value", max_length=20)
    ...
    P_Page_Nos = models.CharField(default="", verbose_name="Number of Pages", max_length=45)
